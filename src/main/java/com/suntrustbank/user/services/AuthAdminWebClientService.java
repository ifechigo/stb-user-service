...
public class AuthAdminWebClientService extends AbstractWebClientService<AuthAdminRequestDto, AuthResponseDto> {
    ...
    @Override
    public AuthResponseDto request(AuthAdminRequestDto requestDto) {
        return callAPI(HttpMethod.POST, "/admin/signup").
            body(BodyInserters.fromValue(requestDto)).
            exchangeToMono(this::toResponseOrError).
            doOnError(exception -> log.error("Error occurred while creating admin user on the Auth service", exception)).
