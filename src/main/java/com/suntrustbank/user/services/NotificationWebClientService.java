...
public class NotificationWebClientService extends AbstractWebClientService<String, AuthResponseDto> {
    ...
    @Override
    public AuthResponseDto request(String requestDto) {
        return callAPI(HttpMethod.POST, "/sms/notify")
            .body(BodyInserters.fromValue(requestDto))
            .exchangeToMono(this::toResponseOrError)
            .doOnError(exception -> log.error("Error occurred while sending message via Notification service", exception))
